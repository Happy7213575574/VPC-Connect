...
namespace ConnectApp.Extensions
{
    public class NotificationHelper
    {
        ...
        public static string GetTitle(IDictionary<string, object> notification)
        {
            return Search(notification, titleKeys) ?? "VPC portal notification";
        }

        public static string GetSubtitle(IDictionary<string, object> notification)
        {
            return Search(notification, subtitleKeys);
        }

        public static string GetMessage(IDictionary<string, object> notification)
        {
            return Search(notification, bodyKeys);
        }

        public static string GetTargetUrl(IDictionary<string,object> notification)
        {
            return Search(notification, targetUrlKeys);
        }

        private static string Search(IDictionary<string,object> notification, IEnumerable<string> options)
        {
