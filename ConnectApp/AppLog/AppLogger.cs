...
namespace ConnectApp.AppLog
{
    public class AppLogger
    {
        ...
        public AppLogger(ConnectDb db, string subject = null, bool onDevice = true)
        {
            this.db = db;
